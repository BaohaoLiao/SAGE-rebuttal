...
# CKPT directory
ckpts_dir="/data/agenrrl/baohao/SAGE-rebuttal/outputs/grpo_after_sft_Llama-3.2-3B-Instruct"
data_path="baohao"

# Configuration
K=4  # Number of samples to generate per prompt, used for averaging for a stable metric
GPUS=(4 5 6 7)

# Model and dataset arrays
models=()
for step in $(seq 200 50 200); do
